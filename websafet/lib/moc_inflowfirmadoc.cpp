...
**
** Created: Mon Nov 18 10:41:23 2013
...
void InflowFirmaDoc::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        InflowFirmaDoc *_t = static_cast<InflowFirmaDoc *>(_o);
        switch (_id) {
        case 0: _t->doPrint(); break;
        case 1: _t->viewpdf(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData InflowFirmaDoc::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject InflowFirmaDoc::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_InflowFirmaDoc,
      qt_meta_data_InflowFirmaDoc, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &InflowFirmaDoc::getStaticMetaObject() { return staticMetaObject; }

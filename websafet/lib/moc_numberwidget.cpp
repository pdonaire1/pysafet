...
void NumberWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        NumberWidget *_t = static_cast<NumberWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData NumberWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NumberWidget::staticMetaObject = {
    { &CmdWidget::staticMetaObject, qt_meta_stringdata_NumberWidget,
      qt_meta_data_NumberWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &NumberWidget::getStaticMetaObject() { return staticMetaObject; }

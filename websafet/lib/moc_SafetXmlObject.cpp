...
**
** Created: Mon Nov 18 10:41:08 2013
...
void SafetXmlObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData SafetXmlObject::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SafetXmlObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SafetXmlObject,
      qt_meta_data_SafetXmlObject, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SafetXmlObject::getStaticMetaObject() { return staticMetaObject; }

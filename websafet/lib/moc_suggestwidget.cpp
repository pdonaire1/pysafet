...
**
** Created: Mon Nov 18 10:41:22 2013
...
void SuggestWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        SuggestWidget *_t = static_cast<SuggestWidget *>(_o);
        switch (_id) {
        case 0: _t->insertAndClose(); break;
...
const QMetaObjectExtraData SuggestWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SuggestWidget::staticMetaObject = {
    { &CmdWidget::staticMetaObject, qt_meta_stringdata_SuggestWidget,
      qt_meta_data_SuggestWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SuggestWidget::getStaticMetaObject() { return staticMetaObject; }

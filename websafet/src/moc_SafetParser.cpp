...
**
** Created: Mon Nov 18 10:38:55 2013
...
void SafetParser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData SafetParser::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SafetParser::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SafetParser,
      qt_meta_data_SafetParser, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SafetParser::getStaticMetaObject() { return staticMetaObject; }
